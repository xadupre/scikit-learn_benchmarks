...
class PCA_bench(Benchmark, Estimator, Transformer):
    """
    Benchmarks for PCA.
    """
...
class DictionaryLearning_bench(Benchmark, Estimator, Transformer):
    """
...
class MiniBatchDictionaryLearning_bench(Benchmark, Estimator, Transformer):
    """
